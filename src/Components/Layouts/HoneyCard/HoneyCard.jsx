  ...
  useEffect(() => {
    switch (active) {
      case 1:
        ...
        setDiscPrice(priceDiskLists.pricedis125ml)
        break
      case 2:
        setPrice(priceLists.price325ml)
        setDiscPrice(priceDiskLists.pricedis325ml)
        break
      case 3:
        setPrice(priceLists.price500ml)
        setDiscPrice(priceDiskLists.pricedis500ml)
        break
      case 4:
        setPrice(priceLists.price1000ml)
        setDiscPrice(priceDiskLists.pricedis1000ml)
        break
      default:
        break
    }
    ...
    <div className="col-lg-6 col-md-12">
      <div className="HoneyCard">
        ...
        <div className="HoneyCardContent">
          ...
          <p>Warna : {color}</p>
          <p>
            Harga normal &nbsp;: <strong className="price"><del>{discPrice}</del></strong>
          </p>
          <br/>
          <p>
            Harga Discount &nbsp; : <strong className="price">{price}</strong>
          </p>
          <h3>VARIAN UKURAN</h3>
          <div className="row">
            <div className="col-6">
